...
for dir in directories:
        ...
        output_parameters[dir]['fitness'] = {'threshold': threshold}
        ...
        output_parameters[dir]['SVM'] = acc_param[acc_value.index(np.nanmax(acc_value))]
        ...
        output_parameters[dir]["RF"] = {'RF':{'n_estimators': best_param['n_estimators']}, 'pca':{'variance_threshold':  best_param['variance_threshold']}}
        ...
        best_param['variance_threshold'] = best_param['pca__variance_threshold']
        del best_param['pca__variance_threshold']
        output_parameters[dir]["XGboost"] = {'XGboost':{'booster': best_param['booster'],'eta': best_param['eta'],'n_estimators': best_param['n_estimators']}, 'pca': {'variance_threshold':best_param['variance_threshold']}}
        for i in range(len(clf.cv_results_['mean_test_score'])):
        ...
        plt.xticks(rotation=45, ha='right', fontsize=10)
        output_parameters[dir]["Adaboost"] = {'Adaboost':{'n_estimators': best_param['n_estimators'],'learning_rate': best_param['learning_rate']}, 'pca':{'variance_threshold': best_param['variance_threshold']}}
        ...
        output_parameters[dir]['IF'] = acc_param[acc_value.index(np.nanmax(acc_value))]
